...
public class Storage{
	...
	private DBGui mainGui;
	private FileStorageManager xStorage;
	private StorageConfig xmlStorageConfig;
	...
	public static void main(String [] args) throws Exception
	{
		...
		s1.CreateStorage("myDiskSampleTest2", 16*1024, 3500*1024);
		s1.printStats();
	}
